...
namespace PropertyRenumbering.Data.Migrations
{
    /// <inheritdoc />
    public partial class initialmigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    PropertyNumber = table.Column<string>(type: "nvarchar(75)", maxLength: 75, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ExistingDetails", x => x.PropertyNumber);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PropertyRegistration_AllocationTypes_AllocationTypeId",
                        column: x => x.AllocationTypeId,
                        principalTable: "AllocationTypes",
                        principalColumn: "AllocationTypeId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PropertyRegistration_LandUses_LandUseId",
                        column: x => x.LandUseId,
                        principalTable: "LandUses",
                        principalColumn: "LandUseId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PropertyRegistration_Localities_LocalityId",
                        column: x => x.LocalityId,
                        principalTable: "Localities",
                        principalColumn: "LocalityId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PropertyRegistration_PropertyTypes_PropertyTypeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PropertyRegistration_AllocationTypeId",
                table: "PropertyRegistration",
                column: "AllocationTypeId");

            migrationBuilder.CreateIndex(
                name: "IX_PropertyRegistration_LandUseId",
                table: "PropertyRegistration",
                column: "LandUseId");

            migrationBuilder.CreateIndex(
                name: "IX_PropertyRegistration_LocalityId",
                table: "PropertyRegistration",
                column: "LocalityId");

            migrationBuilder.CreateIndex(
                name: "IX_PropertyRegistration_PropertyTypeId",
                table: "PropertyRegistration",
